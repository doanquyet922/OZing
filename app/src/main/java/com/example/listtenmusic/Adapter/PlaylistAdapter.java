...
public class PlaylistAdapter extends ArrayAdapter<PlayList> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Picasso.with(getContext()).load(playList.getHinhNen()).into(viewHolder.imbackground);
        Picasso.with(getContext()).load(playList.getHinhicon()).into(viewHolder.imPlaylist);
        viewHolder.tTenPlaylist.setText(playList.getTenPlayList());
